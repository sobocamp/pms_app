...
<div class="row">
   <div class="col-12 col-xl-12">
      <div class="card">
         <div class="card-body">
            <form id="formPengumuman" method="post" action="{{ route('periode.update', $periode->id) }}">
               @csrf
               @method('patch')
               <div class="row">
                  <div class="mb-3">
               ...
               <div class="row">
                  <div class="mb-3">
                     ...
                     <input type="datetime" class="form-control @error('start_date') is-invalid @enderror" id="start_date"
                        name="start_date" value="{{ $periode->start_date }}">
                     @error('start_date')
                     <div class="invalid-feedback">
                        {{ $message }}
                     </div>
               ...
               <div class="row">
                  <div class="mb-3">
                     ...
                     <input type="datetime" class="form-control @error('end_date') is-invalid @enderror"
                        id="end_date" name="end_date" value="{{ $periode->end_date }}">
                     @error('end_date')
                     <div class="invalid-feedback">
                        {{ $message }}
                     </div>
               ...
               <div class="row">
                  <div class="mb-3">
                     ...
                     <select class="form-select @error('is_active') is-invalid @enderror" id="is_active"
                        name="is_active">
                        <option value="0" {{ $periode->is_active=='0' ? 'selected' : '' }}>Tidak</option>
                        <option value="1" {{ $periode->is_active=='1' ? 'selected' : '' }}>Ya</option>
                     </select>
                     @error('is_active')
                     <div class="invalid-feedback">
                        {{ $message }}
